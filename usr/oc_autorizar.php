...
<br/><br/><br/>
        ...
        <div class="clearfix clear-columns">
            <h4>Listado de Ordenes Pendientes de Autorización</h4>
        </div>
        ...
        $.ajax(
            {
                ...
                async:false,
                data: { 
                    Accion : 'jsonListarOrdenesPendientes',
                    },
                dataType: 'json',
                beforeSend: function () {
...
function autorizarOC(orden){
            swal({
                  title: "¿Está seguro que desea autorizar la orden?",
                  text: "Esta autorización no podrá deshacerse después",
                  type: 'warning',
