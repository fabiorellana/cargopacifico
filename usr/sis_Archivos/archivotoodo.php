...
$id=$_POST['id'];
$sql="select int_archivos.nombre, ges_trabajadores.Nombre, 
int_archivos.id, int_archivos.fecha, int_archivos.descripcion, int_archivos.tamanio, int_archivos.ruta from int_archivos INNER JOIN ges_trabajadores where ges_trabajadores.Rut=int_archivos.rut_usr_up and int_archivos.id=$id";
...
<br>
<div align="center" >
<div class="col-lg-6">Feacha creación<br><?php echo $row['fecha']?></div>

<div class="col-lg-6">Subido por<br><?php echo $row['Nombre']?>
          </div>

</div>
<br>
<br>
<div class="col-lg-12"><br><form method="post" action="bbb.php" >
...
<div>Compartido con: <br><?php $sqlcompartido="SELECT ges_trabajadores.Nombre from ges_trabajadores INNER JOIN int_permisos_archivos 
where int_permisos_archivos.id_usuario=ges_trabajadores.Rut and int_permisos_archivos.id_archivo='$ids'";
